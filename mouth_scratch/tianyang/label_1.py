...
# Excel文件路径
excel_file = r'D:\桌面\香港泰康诺生物科技有限公司\scratch\no scratch.xlsx'  # 请替换为你的Excel文件路径
...
df.to_excel(r'D:\桌面\香港泰康诺生物科技有限公司\scratch\label_with_frames_no_scrach.xlsx', index=False)